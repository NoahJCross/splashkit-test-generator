...
begin
    InitCustomLogger('test_logging1', true, LogMode.LOG_CONSOLE_AND_FILE);
...
begin
    InitCustomLogger('test_logging2', true, LogMode.LOG_CONSOLE_AND_FILE);
    CleanupLogger := TLoggerCleanup.Create;
    Log(LogLevel.INFO, 'This message should appear in both console and file.');
    InitCustomLogger('test_logging3', false, LogMode.LOG_FILE_ONLY);
    Log(LogLevel.INFO, 'This message should only appear in the file.');
end;
procedure TestLogIntegration;
begin
    InitCustomLogger('test_logging4', true, LogMode.LOG_CONSOLE_AND_FILE);
    CleanupLogger := TLoggerCleanup.Create;
    Log(LogLevel.INFO, 'This message should appear in both console and file.');
end;
end;
