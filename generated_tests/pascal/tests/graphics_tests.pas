...
begin
    ...
    RefreshScreen();
    AssertEquals(ColorRed(), GetPixel(testWindow, 125.0, 125.0));
    AssertEquals(ColorGreen(), GetPixel(testWindow, 350.0, 350.0));
    CloseWindow(testWindow);
end;
...
begin
    ...
    AssertEquals(ColorBlack(), GetPixel(loadedBitmap, 50.0, 50.0));
    AssertEquals(ColorWhite(), GetPixel(loadedBitmap, 75.0, 75.0));
