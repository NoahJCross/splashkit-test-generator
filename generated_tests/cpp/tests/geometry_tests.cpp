...
#include "splashkit.h"
#include "../helpers.hpp"
struct TestGeometryFixture
{
};
TEST_CASE_METHOD(TestGeometryFixture, "center_point_of_circle_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "circle_at_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "circle_at_from_points_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "circle_radius_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
    auto test_radius = circle_radius(test_circle);
    REQUIRE(50.0 == test_radius);
}
TEST_CASE_METHOD(TestGeometryFixture, "circle_triangle_intersect_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "circle_triangle_intersect_get_closest_point_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
    auto test_triangle = triangle_from(point_at(50.0, 50.0), point_at(150.0, 50.0), point_at(100.0, 150.0));
...
TEST_CASE_METHOD(TestGeometryFixture, "circle_x_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
    REQUIRE(100.0 == circle_x(test_circle));
}
TEST_CASE_METHOD(TestGeometryFixture, "circle_y_integration") {
    auto test_circle = circle_at(100.0, 150.0, 50.0);
    REQUIRE(150.0 == circle_y(test_circle));
}
TEST_CASE_METHOD(TestGeometryFixture, "circles_intersect_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "circles_intersect_using_values_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "closest_point_on_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "closest_point_on_line_from_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "closest_point_on_rect_from_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
    ...
    auto test_distance = point_point_distance(center_point(test_circle), test_closest_point);
    REQUIRE(test_distance <= circle_radius(test_circle));
}
TEST_CASE_METHOD(TestGeometryFixture, "closest_point_on_triangle_from_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
    auto test_triangle = triangle_from(point_at(50.0, 50.0), point_at(150.0, 50.0), point_at(100.0, 150.0));
...
TEST_CASE_METHOD(TestGeometryFixture, "distant_point_on_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "distant_point_on_circle_heading_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "ray_circle_intersect_distance_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "tangent_points_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "widest_points_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "cosine_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "sine_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "tangent_integration") {
    auto test_tangent_result = tangent(45.0f);
    REQUIRE((test_tangent_result >= 1.0)); REQUIRE((test_tangent_result <= 2.0));
}
TEST_CASE_METHOD(TestGeometryFixture, "closest_point_on_line_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "closest_point_on_lines_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_from_point_to_point_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_from_start_with_offset_integration") {
    auto test_start_point = point_at(0.0, 0.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "line_from_vector_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_from_integration") {
    auto test_line = line_from(0.0, 0.0, 10.0, 10.0);
    REQUIRE(abs(14.1421356 - line_length(test_line)) <= 2.0);
}
TEST_CASE_METHOD(TestGeometryFixture, "line_intersection_point_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_intersects_circle_integration") {
    auto test_line = line_from(0.0, 0.0, 10.0, 10.0);
    auto test_circle = circle_at(5.0, 5.0, 3.0);
    auto test_result = line_intersects_circle(test_line, test_circle);
    REQUIRE(test_result);
}
TEST_CASE_METHOD(TestGeometryFixture, "line_intersects_lines_integration") {
    auto test_line = line_from(0.0, 0.0, 10.0, 10.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "line_intersects_rect_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_length_integration") {
    auto test_line = line_from(point_at(0.0, 0.0), point_at(3.0, 4.0));
    auto test_length = line_length(test_line);
    REQUIRE(5.0 == test_length);
}
TEST_CASE_METHOD(TestGeometryFixture, "line_length_squared_integration") {
    auto test_line = line_from(point_at(0.0, 0.0), point_at(3.0, 4.0));
    auto test_result = line_length_squared(test_line);
    REQUIRE(25.0 == test_result);
}
TEST_CASE_METHOD(TestGeometryFixture, "line_mid_point_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_normal_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "line_to_string_integration") {
    auto test_line = line_from(point_at(0.0, 0.0), point_at(100.0, 100.0));
    auto test_line_string = line_to_string(test_line);
    REQUIRE("Line from Pt @0:0 to Pt @100:100" != test_line_string);
}
TEST_CASE_METHOD(TestGeometryFixture, "lines_from_rectangle_integration") {
    auto test_rectangle = rectangle_from(0.0, 0.0, 100.0, 100.0);
    auto test_lines = lines_from(test_rectangle);
    REQUIRE(4 == test_lines.size());
}
TEST_CASE_METHOD(TestGeometryFixture, "lines_from_triangle_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "lines_intersect_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_at_integration") {
    auto test_point = point_at(10.0, 20.0);
    REQUIRE(10.0 == test_point.x);
    REQUIRE(20.0 == test_point.y);
}
TEST_CASE_METHOD(TestGeometryFixture, "point_at_origin_integration") {
    auto test_point = point_at_origin();
    REQUIRE(0.0 == test_point.x);
    REQUIRE(0.0 == test_point.y);
}
TEST_CASE_METHOD(TestGeometryFixture, "point_in_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "point_in_circle_with_values_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_in_quad_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_in_rectangle_integration") {
    auto test_rectangle = rectangle_from(0.0, 0.0, 100.0, 100.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "point_in_rectangle_with_values_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_in_triangle_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_line_distance_integration") {
    auto test_point = point_at(0.0, 0.0);
    auto test_line = line_from(0.0, 0.0, 10.0, 10.0);
    auto test_distance = point_line_distance(test_point, test_line);
    REQUIRE(0.0 == test_distance);
}
TEST_CASE_METHOD(TestGeometryFixture, "point_offset_by_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_offset_from_origin_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "point_on_line_integration") {
    auto test_line = line_from(0.0, 0.0, 10.0, 10.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "point_on_line_with_proximity_integration") {
    auto test_line = line_from(point_at(0.0, 0.0), point_at(10.0, 10.0));
    auto test_point_on_line = point_at(5.0, 5.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "point_point_angle_integration") {
    auto test_point1 = point_at(0.0, 0.0);
    auto test_point2 = point_at(1.0, 0.0);
    auto test_angle = point_point_angle(test_point1, test_point2);
    REQUIRE(0.0 == test_angle);
}
TEST_CASE_METHOD(TestGeometryFixture, "point_point_distance_integration") {
    auto test_point1 = point_at(0.0, 0.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "point_to_string_integration") {
    auto test_point = point_at(10.0, 20.0);
    auto test_string = point_to_string(test_point);
    REQUIRE("Pt @10.000000:20.000000" == test_string);
}
TEST_CASE_METHOD(TestGeometryFixture, "random_bitmap_point_integration") {
    ...
    REQUIRE((test_point.x >= 0.0)); REQUIRE((test_point.x <= bitmap_width(test_bitmap)));
    REQUIRE((test_point.y >= 0.0)); REQUIRE((test_point.y <= bitmap_height(test_bitmap)));
}
TEST_CASE_METHOD(TestGeometryFixture, "random_screen_point_integration") {
    auto test_window = open_window("Test Window 3", 800, 600);
    window_cleanup cleanup_window;
    auto test_point = random_screen_point();
    refresh_screen();
    REQUIRE((test_point.x >= 0.0)); REQUIRE((test_point.x <= window_width(test_window)));
    REQUIRE((test_point.y >= 0.0)); REQUIRE((test_point.y <= window_height(test_window)));
}
TEST_CASE_METHOD(TestGeometryFixture, "random_window_point_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "same_point_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "quad_from_points_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "quad_from_rectangle_integration") {
    auto test_rectangle = rectangle_from(0.0, 0.0, 100.0, 100.0);
    auto test_quad = quad_from(test_rectangle);
    REQUIRE(point_in_quad(point_at(50.0, 51.0), test_quad));
    REQUIRE_FALSE(point_in_quad(point_at(150.0, 150.0), test_quad));
}
TEST_CASE_METHOD(TestGeometryFixture, "quad_from_rectangle_with_transformation_integration") {
    auto test_rectangle = rectangle_from(0.0, 0.0, 100.0, 100.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "quad_from_integration") {
    auto test_quad = quad_from(0.0, 0.0, 100.0, 0.0, 0.0, 100.0, 100.0, 100.0);
    REQUIRE(point_in_quad(point_at(50.0, 51.0), test_quad));
    REQUIRE_FALSE(point_in_quad(point_at(150.0, 150.0), test_quad));
}
TEST_CASE_METHOD(TestGeometryFixture, "quads_intersect_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "set_quad_point_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "triangles_from_integration") {
    auto test_quad = quad_from(point_at(0.0, 0.0), point_at(100.0, 0.0), point_at(0.0, 100.0), point_at(100.0, 100.0));
    auto test_triangles = triangles_from(test_quad);
    REQUIRE(2 == test_triangles.size());
}
TEST_CASE_METHOD(TestGeometryFixture, "inset_rectangle_integration") {
    auto test_rectangle = rectangle_from(0.0, 0.0, 100.0, 100.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "intersection_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_around_circle_integration") {
    auto test_circle = circle_at(100.0, 100.0, 50.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_around_line_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_around_quad_integration") {
    auto test_quad = quad_from(point_at(0.0, 0.0), point_at(100.0, 0.0), point_at(0.0, 100.0), point_at(100.0, 100.0));
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_around_triangle_integration") {
    auto test_triangle = triangle_from(point_at(0.0, 0.0), point_at(100.0, 0.0), point_at(50.0, 100.0));
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_bottom_integration") {
    auto test_rectangle = rectangle_from(10.0, 20.0, 50.0, 60.0);
    REQUIRE(80.0 == rectangle_bottom(test_rectangle));
}
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_center_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_from_point_and_size_integration") {
    auto test_point = point_at(10.0, 20.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_from_points_integration") {
    auto test_point1 = point_at(0.0, 0.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_from_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_left_integration") {
    auto test_rectangle = rectangle_from(10.0, 20.0, 50.0, 60.0);
    auto test_left = rectangle_left(test_rectangle);
    REQUIRE(10.0 == test_left);
}
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_offset_by_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_right_integration") {
    auto test_rectangle = rectangle_from(10.0, 20.0, 50.0, 60.0);
    REQUIRE(60.0 == rectangle_right(test_rectangle));
}
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_to_string_integration") {
    auto test_rectangle = rectangle_from(10.0, 20.0, 30.0, 40.0);
    auto test_string = rectangle_to_string(test_rectangle);
    REQUIRE("Rect @10,20 30x40" == test_string);
}
TEST_CASE_METHOD(TestGeometryFixture, "rectangle_top_integration") {
    auto test_rectangle = rectangle_from(10.0, 20.0, 50.0, 60.0);
    auto test_top = rectangle_top(test_rectangle);
    REQUIRE(20.0 == test_top);
}
TEST_CASE_METHOD(TestGeometryFixture, "rectangles_intersect_integration") {
    auto test_rect1 = rectangle_from(0.0, 0.0, 10.0, 10.0);
    auto test_rect2 = rectangle_from(5.0, 5.0, 10.0, 10.0);
    auto test_result = rectangles_intersect(test_rect1, test_rect2);
    REQUIRE(test_result);
}
TEST_CASE_METHOD(TestGeometryFixture, "triangle_barycenter_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "triangle_from_integration") {
    auto test_point1 = point_at(0.0, 0.0);
...
TEST_CASE_METHOD(TestGeometryFixture, "triangle_from__from_coordinates_integration") {
...
TEST_CASE_METHOD(TestGeometryFixture, "triangle_rectangle_intersect_integration") {
    auto test_triangle = triangle_from(point_at(0.0, 0.0), point_at(100.0, 0.0), point_at(50.0, 100.0));
...
TEST_CASE_METHOD(TestGeometryFixture, "triangle_to_string_integration") {
    auto test_triangle = triangle_from(point_at(0.0, 0.0), point_at(100.0, 0.0), point_at(50.0, 100.0));
    auto test_triangle_string = triangle_to_string(test_triangle);
    REQUIRE("Triangle @Pt @0:0 - Pt @100:0 - Pt @50:100" != test_triangle_string);
}
TEST_CASE_METHOD(TestGeometryFixture, "triangles_intersect_integration") {
