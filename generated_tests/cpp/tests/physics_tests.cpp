...
TEST_CASE("bitmap_collision_for_cells_integration") {
    ...
    clear_bitmap(test_bitmap1, color_black());
    clear_bitmap(test_bitmap2, color_black());
    REQUIRE_FALSE(bitmap_collision(test_bitmap1, 0, 100.0, 100.0, test_bitmap2, 0, 150.0, 100.0));
    REQUIRE(bitmap_collision(test_bitmap1, 0, 100.0, 100.0, test_bitmap2, 0, 100.0, 100.0));
    free_all_bitmaps();
    close_window(test_window);
}
...
TEST_CASE("bitmap_point_collision_at_point_integration") {
    ...
    auto test_bitmap = create_bitmap("test_bitmap", 100, 100);
    clear_bitmap(test_bitmap, color_black());
    auto test_bmp_pt = point_at(50.0, 50.0);
    auto test_pt = point_at(50.0, 50.0);
    REQUIRE(bitmap_point_collision(test_bitmap, test_bmp_pt, test_pt));
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
TEST_CASE("bitmap_point_collision_for_cell_at_point_integration") {
    ...
    clear_bitmap(test_bitmap, color_black());
    auto test_point = point_at(100.0, 100.0);
    REQUIRE(bitmap_point_collision(test_bitmap, 0, test_point, test_point));
    free_bitmap(test_bitmap);
    close_window(test_window);
}
TEST_CASE("bitmap_point_collision_for_cell_integration") {
    ...
    auto test_bitmap = create_bitmap("test_bitmap", 100, 100);
    clear_bitmap(test_bitmap, color_black());
    REQUIRE(bitmap_point_collision(test_bitmap, 0, 100.0, 100.0, 100.0, 100.0));
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
TEST_CASE("sprite_point_collision_integration") {
    ...
    auto test_sprite = create_sprite(test_bitmap);
    sprite_set_collision_kind(test_sprite, pixel_collisions);
    REQUIRE(sprite_point_collision(test_sprite, point_at(50.0, 50.0)));
...
TEST_CASE("apply_matrix_to_quad_integration") {
    ...
    REQUIRE(100.0 == {:value_type=>"array_access_field", :variable_name=>"test_quad", :array_name=>"points", :index=>0, :field=>"x"});
    REQUIRE(100.0 == {:value_type=>"array_access_field", :variable_name=>"test_quad", :array_name=>"points", :index=>0, :field=>"y"});
    close_window(test_window);
}
TEST_CASE("apply_matrix_to_triangle_integration") {
    ...
    REQUIRE(1.0 == {:value_type=>"array_access_field", :variable_name=>"test_triangle", :array_name=>"points", :index=>0, :field=>"x"});
    REQUIRE(1.0 == {:value_type=>"array_access_field", :variable_name=>"test_triangle", :array_name=>"points", :index=>0, :field=>"y"});
}
TEST_CASE("identity_matrix_integration") {
    auto test_matrix = identity_matrix();
    REQUIRE(1.0 == {:value_type=>"matrix_access", :variable_name=>"test_matrix", :field=>"elements", :row=>0, :col=>0});
    REQUIRE(1.0 == {:value_type=>"matrix_access", :variable_name=>"test_matrix", :field=>"elements", :row=>1, :col=>1});
    REQUIRE(0.0 == {:value_type=>"matrix_access", :variable_name=>"test_matrix", :field=>"elements", :row=>0, :col=>1});
    REQUIRE(0.0 == {:value_type=>"matrix_access", :variable_name=>"test_matrix", :field=>"elements", :row=>1, :col=>0});
}
TEST_CASE("matrix_inverse_integration") {
    ...
    REQUIRE(1.0 == {:value_type=>"matrix_access", :variable_name=>"result_matrix", :field=>"elements", :row=>0, :col=>0});
    REQUIRE(1.0 == {:value_type=>"matrix_access", :variable_name=>"result_matrix", :field=>"elements", :row=>1, :col=>1});
}
...
TEST_CASE("matrix_multiply_matrix_integration") {
    ...
    REQUIRE(2.0 == {:value_type=>"matrix_access", :variable_name=>"result_matrix", :field=>"elements", :row=>0, :col=>0});
    REQUIRE(20.0 == {:value_type=>"matrix_access", :variable_name=>"result_matrix", :field=>"elements", :row=>0, :col=>2});
}
...
TEST_CASE("matrix_to_string_integration") {
    auto test_matrix = identity_matrix();
    REQUIRE(expected == matrix_to_string(test_matrix));
}
TEST_CASE("rotation_matrix_integration") {
    auto test_matrix = rotation_matrix(90.0);
    auto test_point = point_at(1.0, 0.0);
    auto result_point = matrix_multiply(test_matrix, test_point);
    REQUIRE(result_point->x >= -0.1 && result_point->x <= );
    REQUIRE(result_point->y >= 0.9 && result_point->y <= );
}
...
TEST_CASE("scale_rotate_translate_matrix_integration") {
    ...
    auto test_point = point_at(1.0, 0.0);
    auto result_point = matrix_multiply(test_matrix, test_point);
    REQUIRE(result_point->x >= 9.9 && result_point->x <= );
    REQUIRE(result_point->y >= 11.9 && result_point->y <= );
}
...
TEST_CASE("vector_from_angle_integration") {
    ...
    REQUIRE(0.7071 == test_vector->x);
    REQUIRE(0.7071 == test_vector->y);
}
...
TEST_CASE("vector_normal_integration") {
    ...
    REQUIRE(-4.0 == normal_vector->x);
    REQUIRE(3.0 == normal_vector->y);
}
TEST_CASE("vector_out_of_circle_from_circle_integration") {
    auto test_circle_src = circle_at(0.0, 0.0, 10.0);
    auto test_circle_bounds = circle_at(15.0, 0.0, 10.0);
...
TEST_CASE("vector_out_of_circle_from_point_integration") {
    ...
    REQUIRE(-50.0 == result_vector->x);
    REQUIRE(-50.0 == result_vector->y);
}
...
TEST_CASE("vector_to_string_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    REQUIRE("Vec -> 3:4" == vector_to_string(test_vector));
}
