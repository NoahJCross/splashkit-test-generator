...
public:
    ...
    TEST_CASE("bitmap_collision_integration") {
        auto test_bitmap1 = create_bitmap(string("test_bitmap1"), 100, 100);
        BitmapCleanup cleanup_bitmap;
        auto test_bitmap2 = create_bitmap(string("test_bitmap2"), 100, 100);
    ...
    TEST_CASE("bitmap_collision_for_cells_at_points_integration") {
        auto test_bitmap1 = create_bitmap(string("test_bitmap1"), 50, 50);
        BitmapCleanup cleanup_bitmap;
        auto test_bitmap2 = create_bitmap(string("test_bitmap2"), 50, 50);
        clear_bitmap(test_bitmap1, color_black());
        setup_collision_mask(test_bitmap1);
        clear_bitmap(test_bitmap2, color_black());
        setup_collision_mask(test_bitmap2);
    ...
    TEST_CASE("bitmap_point_collision_with_translation_integration") {
        ...
        setup_collision_mask(test_bitmap);
        auto test_translation = translation_matrix(100.0, 100.0);
        auto test_point1 = point_at(151.0, 150.0);
        auto test_point2 = point_at(201.0, 200.0);
    ...
    TEST_CASE("bitmap_point_collision_integration") {
        ...
        clear_bitmap(test_bitmap, color_black());
        setup_collision_mask(test_bitmap);
        REQUIRE(bitmap_point_collision(test_bitmap, 0.0, 0.0, 51.0, 50.0));
        REQUIRE_FALSE(bitmap_point_collision(test_bitmap, 0.0, 0.0, 151.0, 150.0));
    }
    ...
    TEST_CASE("bitmap_point_collision_for_cell_at_point_integration") {
        ...
        clear_bitmap(test_bitmap, color_black());
        setup_collision_mask(test_bitmap);
        REQUIRE(bitmap_point_collision(test_bitmap, 0, point_at(50.0, 50.0), point_at(101.0, 100.0)));
        REQUIRE_FALSE(bitmap_point_collision(test_bitmap, 0, point_at(51.0, 50.0), point_at(201.0, 200.0)));
    }
    TEST_CASE("bitmap_point_collision_for_cell_integration") {
        auto test_bitmap = create_bitmap(string("test_bitmap"), 100, 100);
        BitmapCleanup cleanup_bitmap;
        clear_bitmap(test_bitmap, color_black());
        draw_pixel(color_white(), 51.0, 50.0, option_draw_to(test_bitmap));
        setup_collision_mask(test_bitmap);
        REQUIRE(bitmap_point_collision(test_bitmap, 0, 0.0, 0.0, 51.0, 50.0));
        REQUIRE_FALSE(bitmap_point_collision(test_bitmap, 0, 0.0, 0.0, 50.0, 50.0));
    }
    ...
    TEST_CASE("sprite_collision_integration") {
        auto test_bitmap1 = create_bitmap(string("test_bitmap_1"), 50, 50);
        BitmapCleanup cleanup_bitmap;
        auto test_bitmap2 = create_bitmap(string("test_bitmap_2"), 50, 50);
        clear_bitmap(test_bitmap1, color_black());
        setup_collision_mask(test_bitmap1);
        clear_bitmap(test_bitmap2, color_black());
        setup_collision_mask(test_bitmap2);
    ...
    TEST_CASE("matrix_inverse_integration") {
        ...
        REQUIRE(abs(1.0 - result_matrix.elements[0][0]) <= 2);
        REQUIRE(abs(1.0 - result_matrix.elements[1][1]) <= 2);
    }
    ...
    TEST_CASE("vector_limit_integration") {
        ...
        REQUIRE(abs(3.0 - limited_vector.x) <= 2);
    ...
    TEST_CASE("vector_to_string_integration") {
        auto test_vector = vector_to(3.0, 4.0);
        REQUIRE(string("Vec -> 3.000000:4.000000") == vector_to_string(test_vector));
    }
