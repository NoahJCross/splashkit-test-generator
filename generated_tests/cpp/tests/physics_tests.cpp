...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_circle_collision_at_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_circle_collision_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_circle_collision_for_cell_with_translation_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_circle_collision_for_cell_at_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_circle_collision_for_cell_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_collision_integration") {
    auto test_bitmap1 = create_bitmap("Test Bitmap 6", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    auto test_bitmap2 = create_bitmap("Test Bitmap 7", 100, 100);
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_collision_at_points_integration") {
    auto test_bitmap1 = create_bitmap("Test Bitmap 8", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    auto test_bitmap2 = create_bitmap("Test Bitmap 9", 100, 100);
    clear_bitmap(test_bitmap1, color_white());
    setup_collision_mask(test_bitmap1);
    clear_bitmap(test_bitmap2, color_white());
    setup_collision_mask(test_bitmap2);
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_collision_for_cells_with_translations_integration") {
    auto test_bitmap1 = create_bitmap("Test Bitmap 10", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    auto test_bitmap2 = create_bitmap("Test Bitmap 11", 100, 100);
    clear_bitmap(test_bitmap1, color_white());
    setup_collision_mask(test_bitmap1);
    clear_bitmap(test_bitmap2, color_white());
    setup_collision_mask(test_bitmap2);
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_collision_for_cells_at_points_integration") {
    auto test_bitmap1 = create_bitmap("Test Bitmap 12", 50, 50);
    bitmap_cleanup cleanup_bitmap;
    auto test_bitmap2 = create_bitmap("Test Bitmap 13", 50, 50);
    clear_bitmap(test_bitmap1, color_white());
    setup_collision_mask(test_bitmap1);
    clear_bitmap(test_bitmap2, color_white());
    setup_collision_mask(test_bitmap2);
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_collision_for_cells_integration") {
    auto test_bitmap1 = create_bitmap("Test Bitmap 14", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    auto test_bitmap2 = create_bitmap("Test Bitmap 15", 100, 100);
    clear_bitmap(test_bitmap1, color_white());
    clear_bitmap(test_bitmap2, color_white());
    setup_collision_mask(test_bitmap1);
    setup_collision_mask(test_bitmap2);
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_point_collision_with_translation_integration") {
    auto test_bitmap = create_bitmap("Test Bitmap 16", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    clear_bitmap(test_bitmap, color_white());
    setup_collision_mask(test_bitmap);
    auto test_translation = translation_matrix(100.0, 100.0);
    auto test_point1 = point_at(150.0, 150.0);
    auto test_point2 = point_at(200.0, 200.0);
    REQUIRE(bitmap_point_collision(test_bitmap, test_translation, test_point1));
    REQUIRE_FALSE(bitmap_point_collision(test_bitmap, test_translation, test_point2));
}
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_point_collision_at_point_integration") {
    auto test_bitmap = create_bitmap("Test Bitmap 17", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    clear_bitmap(test_bitmap, color_white());
    setup_collision_mask(test_bitmap);
    auto test_bmp_point = point_at(50.0, 50.0);
    auto test_point = point_at(101.0, 100.0);
    REQUIRE(bitmap_point_collision(test_bitmap, test_bmp_point, test_point));
    REQUIRE_FALSE(bitmap_point_collision(test_bitmap, test_bmp_point, point_at(201.0, 200.0)));
}
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_point_collision_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_point_collision_for_cell_with_translation_integration") {
    ...
    auto test_point1 = point_at(150.0, 150.0);
    auto test_point2 = point_at(200.0, 200.0);
    REQUIRE(bitmap_point_collision(test_bitmap, 0, test_translation, test_point1));
    REQUIRE_FALSE(bitmap_point_collision(test_bitmap, 0, test_translation, test_point2));
}
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_point_collision_for_cell_at_point_integration") {
    auto test_bitmap = create_bitmap("Test Bitmap 20", 100, 100);
    bitmap_cleanup cleanup_bitmap;
    clear_bitmap(test_bitmap, color_white());
    setup_collision_mask(test_bitmap);
    REQUIRE(bitmap_point_collision(test_bitmap, 0, point_at(50.0, 50.0), point_at(100.0, 100.0)));
    REQUIRE_FALSE(bitmap_point_collision(test_bitmap, 0, point_at(50.0, 50.0), point_at(200.0, 200.0)));
}
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_point_collision_for_cell_integration") {
    ...
    REQUIRE_FALSE(bitmap_point_collision(test_bitmap, 0, 0.0, 0.0, 51.0, 50.0));
}
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_rectangle_collision_at_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_rectangle_collision_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_rectangle_collision_for_cell_with_translation_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_rectangle_collision_for_cell_at_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "bitmap_rectangle_collision_for_cell_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "sprite_bitmap_collision_integration") {
    ...
    sprite_set_collision_kind(test_sprite, collision_test_kind::PIXEL_COLLISIONS);
...
TEST_CASE_METHOD(TestPhysicsFixture, "sprite_bitmap_collision_with_cell_at_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "sprite_bitmap_collision_with_cell_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "sprite_collision_integration") {
    auto test_bitmap1 = create_bitmap("Test Bitmap 30", 50, 50);
    bitmap_cleanup cleanup_bitmap;
    auto test_bitmap2 = create_bitmap("Test Bitmap 31", 50, 50);
    clear_bitmap(test_bitmap1, color_white());
    setup_collision_mask(test_bitmap1);
    clear_bitmap(test_bitmap2, color_white());
    setup_collision_mask(test_bitmap2);
    ...
    sprite_set_collision_kind(test_sprite1, collision_test_kind::PIXEL_COLLISIONS);
    sprite_set_collision_kind(test_sprite2, collision_test_kind::PIXEL_COLLISIONS);
...
TEST_CASE_METHOD(TestPhysicsFixture, "sprite_point_collision_integration") {
    ...
    sprite_cleanup cleanup_sprite;
    sprite_set_collision_kind(test_sprite, collision_test_kind::PIXEL_COLLISIONS);
    REQUIRE(sprite_point_collision(test_sprite, point_at(76.0, 75.0)));
    REQUIRE_FALSE(sprite_point_collision(test_sprite, point_at(200.0, 200.0)));
}
TEST_CASE_METHOD(TestPhysicsFixture, "sprite_rectangle_collision_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "apply_matrix_to_quad_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "apply_matrix_to_triangle_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "identity_matrix_integration") {
    auto test_matrix = identity_matrix();
...
TEST_CASE_METHOD(TestPhysicsFixture, "matrix_inverse_integration") {
    ...
    REQUIRE(abs(1.0 - result_matrix.elements[0][0]) <= 2.0);
    REQUIRE(abs(1.0 - result_matrix.elements[1][1]) <= 2.0);
}
TEST_CASE_METHOD(TestPhysicsFixture, "matrix_multiply_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "matrix_multiply_matrix_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "matrix_multiply_vector_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "matrix_to_string_integration") {
    auto test_matrix = identity_matrix();
    REQUIRE(" ------------------------------\n|        1         0         0 |\n|        0         1         0 |\n|        0         0         1 |\n ------------------------------" == matrix_to_string(test_matrix));
}
TEST_CASE_METHOD(TestPhysicsFixture, "rotation_matrix_integration") {
    auto test_matrix = rotation_matrix(90.0);
    auto test_point = point_at(1.0, 0.0);
    auto result_point = matrix_multiply(test_matrix, test_point);
    REQUIRE(abs(0.0 - result_point.x) <= 2.0);
    REQUIRE(abs(1.0 - result_point.y) <= 2.0);
}
TEST_CASE_METHOD(TestPhysicsFixture, "scale_matrix_from_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "scale_matrix_from_vector_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "scale_matrix_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "scale_rotate_translate_matrix_integration") {
    ...
    REQUIRE(11.0 == result_point.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "translation_matrix_to_point_integration") {
    auto test_point = point_at(10.0, 20.0);
    auto test_matrix = translation_matrix(test_point);
    auto test_vector = vector_to(5.0, 5.0);
    auto result_point = matrix_multiply(test_matrix, test_vector);
    REQUIRE(15.0 == result_point.x);
    REQUIRE(25.0 == result_point.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "translation_matrix_from_vector_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "translation_matrix_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "angle_between_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "dot_product_integration") {
    auto test_vector1 = vector_to(3.0, 4.0);
    auto test_vector2 = vector_to(1.0, 2.0);
    REQUIRE(11.0 == dot_product(test_vector1, test_vector2));
}
TEST_CASE_METHOD(TestPhysicsFixture, "is_zero_vector_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "ray_intersection_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "unit_vector_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    auto test_unit_vector = unit_vector(test_vector);
    REQUIRE(abs(0.6 - test_unit_vector.x) <= 2.0);
    REQUIRE(0.8 == test_unit_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_add_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_angle_integration") {
    auto test_vector = vector_to(1.0, 1.0);
    REQUIRE(45.0 == vector_angle(test_vector));
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_from_angle_integration") {
    auto test_vector = vector_from_angle(0.0, 1.0);
    REQUIRE(1.0 == test_vector.x);
    REQUIRE(0.0 == test_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_from_line_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_from_point_to_rect_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_in_rect_integration") {
    auto test_rect = rectangle_from(0.0, 0.0, 100.0, 100.0);
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_invert_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    auto inverted_vector = vector_invert(test_vector);
    REQUIRE(-3.0 == inverted_vector.x);
    REQUIRE(-4.0 == inverted_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_limit_integration") {
    auto test_vector = vector_to(6.0, 8.0);
    auto limited_vector = vector_limit(test_vector, 5.0);
    REQUIRE(abs(3.0 - limited_vector.x) <= 2.0);
    REQUIRE(4.0 == limited_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_magnitude_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    REQUIRE(5.0 == vector_magnitude(test_vector));
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_magnitude_squared_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    REQUIRE(25.0 == vector_magnitude_squared(test_vector));
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_multiply_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    auto result_vector = vector_multiply(test_vector, 2.0);
    REQUIRE(6.0 == result_vector.x);
    REQUIRE(8.0 == result_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_normal_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    auto normal_vector = vector_normal(test_vector);
    REQUIRE(abs(-0.8 - normal_vector.x) <= 2.0);
    REQUIRE(abs(0.6 - normal_vector.y) <= 2.0);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_out_of_circle_from_circle_integration") {
    ...
    REQUIRE(abs(-3.42 - result_vector.x) <= 2.0);
    REQUIRE(0.0 == result_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_out_of_circle_from_point_integration") {
    auto test_point = point_at(100.0, 100.0);
    ...
    REQUIRE(abs(-11.42 - result_vector.x) <= 2.0);
    REQUIRE(0.0 == result_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_out_of_rect_from_circle_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_out_of_rect_from_point_integration") {
    auto test_point = point_at(75.0, 75.0);
    auto test_rect = rectangle_from(0.0, 0.0, 100.0, 100.0);
    auto test_velocity = vector_to(1.0, 0.0);
    auto result_vector = vector_out_of_rect_from_point(test_point, test_rect, test_velocity);
    REQUIRE(abs(-76.4 - result_vector.x) <= 2.0);
    REQUIRE(0.0 == result_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_out_of_rect_from_rect_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_point_to_point_integration") {
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_subtract_integration") {
    auto test_vector1 = vector_to(3.0, 4.0);
...
TEST_CASE_METHOD(TestPhysicsFixture, "vector_to_point_integration") {
    auto test_point = point_at(3.0, 4.0);
    auto result_vector = vector_to(test_point);
    REQUIRE(3.0 == result_vector.x);
    REQUIRE(4.0 == result_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_to_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    REQUIRE(3.0 == test_vector.x);
    REQUIRE(4.0 == test_vector.y);
}
TEST_CASE_METHOD(TestPhysicsFixture, "vector_to_string_integration") {
    auto test_vector = vector_to(3.0, 4.0);
    REQUIRE("Vec -> 3.000000:4.000000" == vector_to_string(test_vector));
}
TEST_CASE_METHOD(TestPhysicsFixture, "vectors_equal_integration") {
    auto test_vector1 = vector_to(3.0, 4.0);
    auto test_vector2 = vector_to(3.0, 4.0);
...
TEST_CASE_METHOD(TestPhysicsFixture, "vectors_not_equal_integration") {
    auto test_vector1 = vector_to(3.0, 4.0);
    auto test_vector2 = vector_to(3.0, 4.0);
    auto test_vector3 = vector_to(3.0, 5.0);
