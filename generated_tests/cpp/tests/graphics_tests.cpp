...
public:
    ...
    TEST_CASE("pop_clip_integration") {
        ...
        refresh_screen();
        REQUIRE(color_red() == get_pixel(test_window, 125.0, 125.0));
        REQUIRE(color_green() == get_pixel(test_window, 350.0, 350.0));
        close_window(test_window);
    }
    ...
    TEST_CASE("option_with_animation_integration") {
        ...
        auto test_bitmap = create_bitmap(string("test_bitmap"), 100, 100);
        clear_bitmap(test_bitmap, color_black());
        auto test_animation = create_animation(string("test_animation"), string("default"));
    ...
    TEST_CASE("bitmap_height_of_bitmap_named_integration") {
        auto test_bitmap = create_bitmap(string("bitmap_height"), 100, 100);
    ...
    TEST_CASE("bitmap_width_of_bitmap_named_integration") {
        auto test_bitmap = create_bitmap(string("bitmap_width"), 100, 100);
    ...
    TEST_CASE("load_bitmap_integration") {
        ...
        REQUIRE(color_black() == get_pixel(loaded_bitmap, 50.0, 50.0));
        REQUIRE(color_white() == get_pixel(loaded_bitmap, 75.0, 75.0));
    ...
    TEST_CASE("text_height_font_named_integration") {
        auto test_window = open_window(string("Test Window"), 800, 600);
        auto height = text_height(string("Test Text"), string("hara"), 24);
        REQUIRE(height > 0);
        REQUIRE(height >= 24);
        close_window(test_window);
    }
