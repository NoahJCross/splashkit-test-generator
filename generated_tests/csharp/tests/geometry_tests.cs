...
namespace SplashKitTests
{
    public class TestGeometry
    {
        ...
        public void TestClosestPointOnLinesIntegration() {
            ...
            var testClosestPoint = ClosestPointOnLines(testFromPt, testLines, ref testIndex);
        ...
        public void TestLineIntersectionPointIntegration() {
            ...
            var testPoint = PointAt(0.0, 0.0);
            var testIntersectionResult = LineIntersectionPoint(testLine1, testLine2, ref testPoint);
        ...
        public void TestPointOnLineWithProximityIntegration() {
            ...
            Assert.True(PointOnLine(testPointOnLine, testLine, 0.1f));
            Assert.True(PointOnLine(testPointNearLine, testLine, 0.2f));
