...
fn test_call_on_sprite_event_integration() {
    ...
    let test_window = open_window("Test Window", 800, 600);
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
...
fn test_center_point_integration() {
    ...
    let center_point = center_point(test_sprite);
    assert_eq!(150, center_point.X);
    assert_eq!(150, center_point.Y);
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_current_sprite_pack_integration() {
    assert_eq!("default", current_sprite_pack());
    create_sprite_pack("test_pack");
    select_sprite_pack("test_pack");
    assert_eq!("test_pack", current_sprite_pack());
...
fn test_draw_all_sprites_integration() {
    ...
    draw_all_sprites();
    refresh_screen();
    assert_eq!(color_black(), get_pixel(test_window, 100, 100));
    assert_eq!(color_black(), get_pixel(test_window, 200, 200));
    free_all_sprites();
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_draw_sprite_offset_by_integration() {
    ...
    refresh_screen();
    assert_ne!(color_white(), get_pixel(test_window, 450, 350));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_draw_sprite_integration() {
    ...
    refresh_screen();
    assert_eq!(color_black(), get_pixel(test_window, 400, 300));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_free_all_sprites_integration() {
    let test_window = open_window("Test Window", 800, 600);
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite1 = create_sprite("test_sprite1", test_bitmap);
    let test_sprite2 = create_sprite("test_sprite2", test_bitmap);
...
fn test_move_sprite_integration() {
    ...
    assert_eq!(110.0, sprite_x(test_sprite));
    assert_eq!(110.0, sprite_y(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_move_sprite_percent_integration() {
    ...
    assert_eq!(105.0, sprite_x(test_sprite));
    assert_eq!(105.0, sprite_y(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_add_layer_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    let new_layer_bitmap = create_bitmap("new_layer", 50, 50);
...
fn test_sprite_add_value_integration() {
    ...
    assert_eq!(100, sprite_value(test_sprite, "health"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_add_value_with_default_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    sprite_add_value_with_default(test_sprite, "health", 100.0 as f32);
    assert!(sprite_has_value(test_sprite, "health"));
...
fn test_sprite_anchor_point_integration() {
    ...
    assert_eq!(50, anchor_point.X);
    assert_eq!(50, anchor_point.Y);
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_anchor_position_integration() {
    ...
    assert_eq!(150, anchor_position.X);
    assert_eq!(150, anchor_position.Y);
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_animation_has_ended_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_animation = load_animation_script("test_animation", "kermit.txt");
    let test_sprite = create_sprite("test_sprite", test_bitmap, test_animation);
...
fn test_sprite_animation_name_integration() {
    ...
    let test_sprite = create_sprite("test_sprite", test_bitmap, test_animation);
    sprite_start_animation(test_sprite, "walkfront");
    assert_eq!("walkfront", sprite_animation_name(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    free_animation_script(test_animation);
    close_window(test_window);
...
fn test_sprite_at_integration() {
    ...
    assert!(!sprite_at(test_sprite, point_at(600, 500)));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_bring_layer_to_front_integration() {
    ...
    assert_eq!(0, sprite_visible_index_of_layer(test_sprite, "layer2"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_circle_integration() {
    ...
    assert_eq!(50, circle.Center.X);
    assert_eq!(50, circle.Center.Y);
...
fn test_sprite_hide_layer_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    let layer_idx = sprite_add_layer(test_sprite, test_bitmap, "layer2");
...
fn test_sprite_layer_named_integration() {
    ...
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    sprite_add_layer(test_sprite, test_bitmap, "layer2");
    assert_eq!(test_bitmap, sprite_layer_named(test_sprite, "layer2"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_layer_circle_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    let circle = sprite_layer_circle_named(test_sprite, "base_layer");
    assert_eq!(50, circle.Center.X);
    assert_eq!(50, circle.Center.Y);
    assert_eq!(50, circle.Radius);
    free_sprite(test_sprite);
...
fn test_sprite_layer_height_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(100, sprite_layer_height_named(test_sprite, "base_layer"));
    let layer_idx = sprite_add_layer(test_sprite, test_bitmap, "layer2");
...
fn test_sprite_layer_index_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(0, sprite_layer_index(test_sprite, "base_layer"));
    let layer_idx = sprite_add_layer(test_sprite, test_bitmap, "layer2");
    assert_eq!(layer_idx, sprite_layer_index(test_sprite, "layer2"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_layer_name_integration() {
    ...
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    let layer_idx = sprite_add_layer(test_sprite, test_bitmap, "layer2");
    assert_eq!("layer2", sprite_layer_name(test_sprite, layer_idx));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_layer_offset_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(vector_to(0, 0), sprite_layer_offset_named(test_sprite, "base_layer"));
    sprite_set_layer_offset_named(test_sprite, "base_layer", vector_to(10, 10));
    assert_eq!(vector_to(10, 10), sprite_layer_offset_named(test_sprite, "base_layer"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_layer_offset_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(vector_to(0, 0), sprite_layer_offset(test_sprite, 0));
    let layer_idx = sprite_add_layer(test_sprite, test_bitmap, "layer2");
    sprite_set_layer_offset_at_index(test_sprite, layer_idx, vector_to(10, 10));
    assert_eq!(vector_to(10, 10), sprite_layer_offset(test_sprite, layer_idx));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_layer_rectangle_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    let rect = sprite_layer_rectangle_named(test_sprite, "base_layer");
    assert_eq!(0, rect.X);
    assert_eq!(0, rect.Y);
    assert_eq!(100, rect.Width);
    assert_eq!(100, rect.Height);
...
fn test_sprite_layer_width_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(100, sprite_layer_width_named(test_sprite, "base_layer"));
    let layer_idx = sprite_add_layer(test_sprite, test_bitmap, "layer2");
...
fn test_sprite_location_matrix_integration() {
    ...
    assert_eq!(1, matrix.Elements[2, 2]);
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_move_to_taking_seconds_integration() {
    ...
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    sprite_set_position(test_sprite, point_at(100, 100));
    sprite_move_to_taking_seconds(test_sprite, point_at(200, 200), 1.0 as f32);
    update_sprite(test_sprite);
...
fn test_sprite_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(test_sprite, sprite_named("test_sprite"));
    assert!(sprite_named("non_existent_sprite").is_none());
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_on_screen_at_point_integration() {
    ...
    assert!(!sprite_on_screen_at_point(test_sprite, point_at(0, 0)));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_on_screen_at_integration() {
    ...
    assert!(!sprite_on_screen_at(test_sprite, 0, 0));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_position_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(point_at(0, 0), sprite_position(test_sprite));
    sprite_set_position(test_sprite, point_at(400, 300));
    assert_eq!(point_at(400, 300), sprite_position(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_replay_animation_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_animation = load_animation_script("test_animation", "kermit.txt");
    let test_sprite = create_sprite(test_bitmap, test_animation);
    sprite_start_animation(test_sprite, "walkfront");
    assert!(!sprite_animation_has_ended(test_sprite));
...
fn test_sprite_scale_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(1.0, sprite_scale(test_sprite));
    sprite_set_scale(test_sprite, 2.0 as f32);
...
fn test_sprite_send_layer_backward_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    let layer1 = sprite_add_layer(test_sprite, test_bitmap, "layer1");
    sprite_show_layer(test_sprite, layer1);
    let layer2 = sprite_add_layer(test_sprite, test_bitmap, "layer2");
    sprite_show_layer(test_sprite, layer2);
...
fn test_sprite_set_anchor_point_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(point_at(50, 50), sprite_anchor_point(test_sprite));
    sprite_set_anchor_point(test_sprite, point_at(25, 25));
    assert_eq!(point_at(25, 25), sprite_anchor_point(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_set_collision_bitmap_integration() {
    ...
    let new_bitmap = create_bitmap("new_bitmap", 200, 200);
...
fn test_sprite_set_layer_offset_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(vector_to(0, 0), sprite_layer_offset(test_sprite, "base_layer"));
    sprite_set_layer_offset_named(test_sprite, "base_layer", vector_to(10.0, 10.0));
    assert_eq!(vector_to(10.0, 10.0), sprite_layer_offset(test_sprite, "base_layer"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_set_position_integration() {
    ...
    assert_eq!(point_at(0, 0), sprite_position(test_sprite));
    sprite_set_position(test_sprite, point_at(100, 100));
    assert_eq!(point_at(100, 100), sprite_position(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_set_value_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert!(!sprite_has_value(test_sprite, "test_value"));
    sprite_add_value(test_sprite, "test_value", 0.0 as f32);
    sprite_set_value_named(test_sprite, "test_value", 10.5 as f32);
...
fn test_sprite_set_velocity_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(vector_to(0, 0), sprite_velocity(test_sprite));
...
fn test_sprite_set_x_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(0.0, sprite_x(test_sprite));
...
fn test_sprite_set_y_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(0.0, sprite_y(test_sprite));
...
fn test_sprite_show_layer_named_integration() {
    ...
    assert_eq!(1, sprite_visible_layer_count(test_sprite));
    assert_eq!(layer_idx, sprite_show_layer_named(test_sprite, "layer2"));
    assert_eq!(2, sprite_visible_layer_count(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
...
fn test_sprite_stop_calling_on_event_integration() {
    ...
    sprite_call_on_event(test_sprite, helper.sprite_event_handler);
    update_sprite(test_sprite);
    assert_eq!(200, sprite_x(test_sprite));
    sprite_set_x(test_sprite, 100 as f32);
...
fn test_sprite_value_integration() {
    ...
    sprite_add_value(test_sprite, "test_value", 0.0 as f32);
    assert_eq!(10.0, sprite_value(test_sprite, "test_value"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_value_count_integration() {
    ...
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(3, sprite_value_count(test_sprite));
    sprite_add_value_with_default(test_sprite, "health", 0.0 as f32);
    sprite_add_value_with_default(test_sprite, "speed", 0.0 as f32);
...
fn test_sprite_visible_index_of_layer_named_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(0, sprite_visible_index_of_layer_named(test_sprite, "base_layer"));
    sprite_add_layer(test_sprite, test_bitmap, "layer2");
    sprite_show_layer(test_sprite, "layer2");
    assert_eq!(1, sprite_visible_index_of_layer_named(test_sprite, "layer2"));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_sprite_width_integration() {
    ...
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    assert_eq!(1, sprite_scale(test_sprite));
    sprite_set_scale(test_sprite, 2.0 as f32);
    assert_eq!(2, sprite_scale(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_update_all_sprites_integration() {
    ...
    update_all_sprites();
    assert_eq!(vector_to(10, 10), sprite_velocity(test_sprite1));
    assert_eq!(vector_to(-10, -10), sprite_velocity(test_sprite2));
    free_all_sprites();
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_update_all_sprites_percent_integration() {
    ...
    assert_eq!(50.0, sprite_x(test_sprite1));
    assert_eq!(50.0, sprite_y(test_sprite1));
    assert_eq!(-50.0, sprite_x(test_sprite2));
    assert_eq!(-50.0, sprite_y(test_sprite2));
    free_all_sprites();
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_update_sprite_percent_integration() {
    ...
    assert_eq!(50.0, sprite_x(test_sprite));
    assert_eq!(50.0, sprite_y(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_update_sprite_animation_percent_integration() {
    ...
    sprite_start_animation(test_sprite, "walkfront");
    assert!(!sprite_animation_has_ended(test_sprite));
    update_sprite_animation_percent(test_sprite, 100 as f32);
    assert!(sprite_animation_has_ended(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
...
fn test_update_sprite_animation_percent_with_sound_integration() {
    ...
    sprite_start_animation(test_sprite, "walkfront");
    assert!(!sprite_animation_has_ended(test_sprite));
    update_sprite_animation_percent_with_sound(test_sprite, 100 as f32, true);
    assert!(sprite_animation_has_ended(test_sprite));
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
...
fn test_vector_from_center_sprite_to_point_point_integration() {
    ...
    let test_sprite = create_sprite("test_sprite", test_bitmap);
    sprite_set_position(test_sprite, point_at(0, 0));
    let center_point = point_at(50, 50);
    let target_point = point_at(150, 150);
    let vector = vector_from_center_sprite_to_point_point(test_sprite, target_point);
    assert_eq!(100, vector.X);
    assert_eq!(100, vector.Y);
    free_sprite(test_sprite);
    free_bitmap(test_bitmap);
    close_window(test_window);
}
...
fn test_vector_from_to_integration() {
    let test_window = open_window("Test Window", 800, 600);
    let test_bitmap = create_bitmap("test_bitmap", 100, 100);
    let sprite1 = create_sprite("sprite1", test_bitmap);
    let sprite2 = create_sprite("sprite2", test_bitmap);
