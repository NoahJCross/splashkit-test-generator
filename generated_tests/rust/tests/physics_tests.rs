...
fn test_bitmap_point_collision_with_translation_integration() {
    ...
    assert!(bitmap_point_collision_with_translation(test_bitmap, test_translation, test_point));
    free_bitmap(test_bitmap);
    close_window(test_window);
}
#[test]
...
fn test_bitmap_point_collision_for_cell_with_translation_integration() {
    ...
    let test_translation = translation_matrix(100.0, 100.0);
    let test_point = point_at(150.0, 150.0);
    assert!(bitmap_point_collision_for_cell_with_translation(test_bitmap, 0, test_translation, test_point));
    free_bitmap(test_bitmap);
    close_window(test_window);
}
#[test]
...
fn test_sprite_point_collision_integration() {
    ...
    let test_sprite = create_sprite(test_bitmap);
    sprite_set_collision_kind(test_sprite, CollisionTestKind::PixelCollisions);
    assert!(sprite_point_collision(test_sprite, point_at(75.0, 75.0)));
...
fn test_matrix_inverse_integration() {
    ...
    assert_eq!(1.0, result_matrix.Elements[0, 0]);
    assert_eq!(1.0, result_matrix.Elements[1, 1]);
}
#[test]
...
fn test_rotation_matrix_integration() {
    ...
    let result_point = matrix_multiply_point(test_matrix, test_point);
    assert_eq!(0, result_point.X);
    assert_eq!(1, result_point.Y);
}
#[test]
...
fn test_scale_rotate_translate_matrix_integration() {
    ...
    let test_point = point_at(1.0, 0.0);
    let result_point = matrix_multiply_point(test_matrix, test_point);
    assert_eq!(10, result_point.X);
    assert_eq!(11, result_point.Y);
}
#[test]
...
fn test_vector_normal_integration() {
    ...
    assert_eq!(-0.8, normal_vector.X);
    assert_eq!(0.6, normal_vector.Y);
}
#[test]
fn test_vector_out_of_circle_from_circle_integration() {
    let test_circle_src = circle_at(0.0, 0.0, 5.0);
    let test_circle_bounds = circle_at(8.0, 0.0, 5.0);
...
fn test_vector_out_of_rect_from_point_integration() {
    ...
    assert_eq!(-76.4, result_vector.X);
    assert_eq!(0.0, result_vector.Y);
}
#[test]
...
fn test_vector_to_string_integration() {
    let test_vector = vector_from_angle(3.0, 4.0);
    assert_eq!("Vec -> 3.000000:4.000000", vector_to_string(test_vector));
}
#[test]
