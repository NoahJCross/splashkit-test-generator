...
fn test_set_resources_path_integration() {
    set_resources_path("/resources");
    assert_eq!(path_to_resources(), "/resources");
    set_resources_path("/new/resources");
    assert_eq!(path_to_resources(), "/new/resources");
}
