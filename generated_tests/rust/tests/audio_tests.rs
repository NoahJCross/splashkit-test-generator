...
mod test_audio {
    ...
    fn test_fade_music_in_named_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
        fade_music_in_named("Test Music".to_string(), 1000);
    ...
    fn test_fade_music_in_named_with_times_integration() {
        ...
        load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
        fade_music_in_named_with_times("Test Music".to_string(), 2, 1000);
        assert!(music_playing());
    }
    #[test]
    fn test_fade_music_in_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        let test_music = load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
    ...
    fn test_free_music_integration() {
        ...
        assert!(!has_music("Test Music".to_string()));
    }
    #[test]
    ...
    fn test_music_name_integration() {
        ...
        let test_music = load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
        assert_eq!("Test Music".to_string(), music_name(test_music));
    }
    #[test]
    fn test_music_named_integration() {
        ...
        let test_music = load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
        let named_music = music_named("Test Music".to_string());
    ...
    fn test_play_music_named_integration() {
        ...
        load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
        play_music_named("Test Music".to_string());
        assert!(music_playing());
    }
    #[test]
    fn test_play_music_named_with_times_integration() {
        ...
        load_music("Test Music".to_string(), "magical_night.ogg".to_string());
        let _cleanup_music = MusicCleanup::new();
        play_music_named_with_times("Test Music".to_string(), 2);
        assert!(music_playing());
    }
    #[test]
    ...
    fn test_fade_all_sound_effects_out_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        let test_sound1 = load_sound_effect("Test Sound 1".to_string(), "comedy_boing.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        let test_sound2 = load_sound_effect("Test Sound 2".to_string(), "comedy_boing.ogg".to_string());
    ...
    fn test_fade_sound_effect_out_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        let test_sound = load_sound_effect("Test Sound".to_string(), "breakdance.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
    ...
    fn test_free_all_sound_effects_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        load_sound_effect("Test Sound 1".to_string(), "breakdance.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        load_sound_effect("Test Sound 2".to_string(), "comedy_boing.ogg".to_string());
        free_all_sound_effects();
        assert!(!has_sound_effect("Test Sound 1".to_string()));
        assert!(!has_sound_effect("Test Sound 2".to_string()));
    }
    #[test]
    fn test_free_sound_effect_integration() {
        ...
        assert!(!has_sound_effect("Test Sound".to_string()));
    }
    #[test]
    ...
    fn test_play_sound_effect_named_integration() {
        ...
        let test_sound = load_sound_effect("Test Sound".to_string(), "breakdance.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        play_sound_effect_named("Test Sound".to_string());
        assert!(sound_effect_playing(test_sound));
    }
    #[test]
    fn test_play_sound_effect_named_with_volume_integration() {
        ...
        let test_sound = load_sound_effect("Test Sound".to_string(), "breakdance.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        play_sound_effect_named_with_volume("Test Sound".to_string(), 0.75);
        assert!(sound_effect_playing(test_sound));
    }
    #[test]
    fn test_play_sound_effect_named_with_times_integration() {
        ...
        let test_sound = load_sound_effect("Test Sound".to_string(), "breakdance.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        play_sound_effect_named_with_times("Test Sound".to_string(), 3);
        assert!(sound_effect_playing(test_sound));
    }
    #[test]
    fn test_play_sound_effect_named_with_times_and_volume_integration() {
        ...
        let test_sound = load_sound_effect("Test Sound".to_string(), "breakdance.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        play_sound_effect_named_with_times_and_volume("Test Sound".to_string(), 2, 0.75);
        assert!(sound_effect_playing(test_sound));
    }
    #[test]
    ...
    fn test_play_sound_effect_with_times_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        let test_sound = load_sound_effect("Test Sound".to_string(), "SwinGameStart.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
    ...
    fn test_sound_effect_name_integration() {
        ...
        let test_sound = load_sound_effect("Test Sound".to_string(), "SwinGameStart.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        assert_eq!("Test Sound".to_string(), sound_effect_name(test_sound));
    }
    #[test]
    fn test_sound_effect_named_integration() {
        ...
        let test_sound = load_sound_effect("Test Sound".to_string(), "SwinGameStart.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        let named_sound = sound_effect_named("Test Sound".to_string());
    ...
    fn test_sound_effect_playing_named_integration() {
        open_audio();
        let _cleanup_audio = AudioCleanup::new();
        load_sound_effect("Test Sound".to_string(), "SwinGameStart.wav".to_string());
        let _cleanup_sound_effect = SoundEffectCleanup::new();
        play_sound_effect_named("Test Sound".to_string());
        assert!(sound_effect_playing_named("Test Sound".to_string()));
        stop_sound_effect_named("Test Sound".to_string());
        assert!(!sound_effect_playing_named("Test Sound".to_string()));
    }
    #[test]
