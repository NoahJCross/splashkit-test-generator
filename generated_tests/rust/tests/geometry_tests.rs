...
fn test_line_from_point_to_point_integration() {
    ...
    assert_eq!(141.421356, line_length(test_line));
}
#[test]
...
fn test_line_from_vector_integration() {
    ...
    assert_eq!(point_at(100.0, 50.0), test_line.end_point);
}
#[test]
fn test_line_from_integration() {
    let test_line = line_from(0.0, 0.0, 10.0, 10.0);
    assert_eq!(14.1421356, line_length(test_line));
}
#[test]
...
fn test_line_normal_integration() {
    ...
    assert_eq!(-1.0, test_normal.x);
    assert_eq!(1.0, test_normal.y);
}
#[test]
...
fn test_point_offset_by_integration() {
    ...
    assert_eq!(15.0, test_start_point.x);
    assert_eq!(30.0, test_result_point.x);
}
#[test]
...
fn test_triangle_barycenter_integration() {
    ...
    assert_eq!(28.866666666666667, test_barycenter.y);
}
#[test]
