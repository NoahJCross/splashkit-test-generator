...
mod test_resource_bundles {
    ...
    fn test_free_resource_bundle_integration() {
        load_resource_bundle("Test Resource Bundle".to_string(), "test.txt".to_string());
        let _cleanup_resource = ResourceCleanup::new("Test Resource Bundle".to_string());
        assert!(has_resource_bundle("Test Resource Bundle".to_string()));
        assert!(has_bitmap("FrogBmp".to_string()));
        assert!(has_font_name_as_string("hara".to_string()));
        free_resource_bundle("Test Resource Bundle".to_string());
        assert!(!has_resource_bundle("Test Resource Bundle".to_string()));
    }
    #[test]
